using NbnBotClean.Application.Common.Models;
using NbnBotClean.Application.TodoItems.Commands.CreateTodoItem;
using NbnBotClean.Application.TodoItems.Commands.DeleteTodoItem;
using NbnBotClean.Application.TodoItems.Commands.UpdateTodoItem;
using NbnBotClean.Application.TodoItems.Commands.UpdateTodoItemDetail;
using NbnBotClean.Application.TodoItems.Queries.GetTodoItemsWithPagination;
using Microsoft.AspNetCore.Http.HttpResults;

namespace NbnBotClean.Web.Endpoints;
